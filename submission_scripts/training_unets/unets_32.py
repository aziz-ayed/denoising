...
checkpoint_path = base_path + chkp_folder + f'unets_32_{run_id}' + '.hdf5'
summary_path = base_path + log_hist_folder + 'modelsummary_32.txt'
loss_path = base_path + log_hist_folder + 'Loss_32.png'
model_path = base_path + model_folder + 'saving_unets_32'
