#!/bin/bash
#SBATCH --job-name=train_unet_64    # nom du job
...
#SBATCH --output=train_unet_64%j.out  # nom du fichier de sortie
#SBATCH --error=train_unet_64%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
